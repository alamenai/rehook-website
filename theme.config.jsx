const config = {
  logo: () => {
    return (
      <>
        ...
        <span style={{ marginLeft: ".8em", fontWeight: 800, color: "#5881E9" }}>
          Rehook
        </span>
      </>
    );
  ...
  banner: {
    ...
    text: (
      <a href="https://github.com/alamenai/rehook" target="_blank">
       🔨 Rehook is still under development and it may have frequent break changes 🔨
      </a>
    ),
  },
  feedback:{
  ...
  editLink:{
    component:(url)=>{
      console.log(url)
      return <a href={`https://github.com/alamenai/rehook/edit/master/${url.filePath}`}>Edit this page</a>
    }
  }
};
